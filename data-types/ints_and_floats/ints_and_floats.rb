...
class IntsAndFloatsTests < Minitest::Test
  ...
  def test_2
    ...
    assert_equal -6, difference.to_i
  end
  ...
  def test_4
    ...
    # divide unlucky by lucky
    quotient = "#{unlucky / lucky}"
    assert_equal 1.8571428571428572, quotient.to_f
  end
  ...
  def test_6
    ...
    even = (lucky).remainder(2)
    return true if even == 1
    false
